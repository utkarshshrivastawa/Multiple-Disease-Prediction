...
diabetes_model = pickle.load(open(r"C:\Users\utkar\100 days ML\Multiple Disease Pediction\diabetes_model.sav",'rb'))

heart_disease_model = pickle.load(open(r"C:\Users\utkar\100 days ML\Multiple Disease Pediction\heart_model.sav",'rb'))

breast_cancer_model = pickle.load(open(r"C:\Users\utkar\100 days ML\Multiple Disease Pediction\breast_model.sav",'rb'))

stroke_model = pickle.load(open(r"C:\Users\utkar\100 days ML\Multiple Disease Pediction\stroke_model.sav",'rb'))
